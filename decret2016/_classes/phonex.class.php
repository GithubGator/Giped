 ...
 * Modification : ajout de la méthode getPhonex, $sString devient private ainsi que la méthode principale build
 */
class phonex {
     ...
     */
    private function build ($sString) {
     ...
     * method to get a result from the main string
     */

    public function getPhonex($sString) {
        $this->build($sString);
        return  $this -> sString ;
    }
}
